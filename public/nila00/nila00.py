...
class Parser:
  ...
  def statement(self):
    ...
    if self.current_tok.matches(TT_KEYWORD, 'THIRUMBU'):
      res.register_advancement()
      self.advance()
    ...
    if self.current_tok.matches(TT_KEYWORD, 'THODARU'):
      res.register_advancement()
      self.advance()
      return res.success(ContinueNode(pos_start, self.current_tok.pos_start.copy()))

    if self.current_tok.matches(TT_KEYWORD, 'NIRUTHU'):
      res.register_advancement()
      self.advance()
  ...
  def expr(self):
    ...
    if self.current_tok.matches(TT_KEYWORD, 'MARI'):
      res.register_advancement()
      self.advance()
    ...
    node = res.register(self.bin_op(self.comp_expr, ((TT_KEYWORD, 'MATRUM'), (TT_KEYWORD, 'ALLA'))))
  ...
  def comp_expr(self):
    ...
    if self.current_tok.matches(TT_KEYWORD, 'ILLAI'):
  ...
  def atom(self):
    ...
    elif tok.matches(TT_KEYWORD, 'ENDRAL'):
      if_expr = res.register(self.if_expr())
      if res.error: return res
      return res.success(if_expr)

    elif tok.matches(TT_KEYWORD, 'IDHUVARAI'):
      for_expr = res.register(self.for_expr())
      if res.error: return res
      return res.success(for_expr)

    elif tok.matches(TT_KEYWORD, 'APPODHU'):
      while_expr = res.register(self.while_expr())
      if res.error: return res
      return res.success(while_expr)

    elif tok.matches(TT_KEYWORD, 'SEYAL'):
  ...
  def if_expr(self):
    res = ParseResult()
    all_cases = res.register(self.if_expr_cases('ENDRAL'))
    if res.error: return res
    cases, else_case = all_cases
    return res.success(IfNode(cases, else_case))

  def if_expr_b(self):
    return self.if_expr_cases('VERUENDRAL')

  def if_expr_c(self):
    res = ParseResult()
    else_case = None

    if self.current_tok.matches(TT_KEYWORD, 'VERU'):
      res.register_advancement()
      self.advance()
      ...
      if self.current_tok.type == TT_NEWLINE:
        ...
        if self.current_tok.matches(TT_KEYWORD, 'MUDI'):
          res.register_advancement()
          self.advance()
        else:
          return res.failure(InvalidSyntaxError(
  ...
  def if_expr_b_or_c(self):
    ...
    if self.current_tok.matches(TT_KEYWORD, 'VERUENDRAL'):
  ...
  def for_expr(self):
    ...
    if self.current_tok.matches(TT_KEYWORD, 'ADI'):
      res.register_advancement()
      self.advance()
...
class Interpreter:
  ...
  def visit_BinOpNode(self, node, context):
    ...
    elif node.op_tok.matches(TT_KEYWORD, 'MATRUM'):
      result, error = left.anded_by(right)
    elif node.op_tok.matches(TT_KEYWORD, 'ALLA'):
  ...
  def visit_UnaryOpNode(self, node, context):
    ...
    elif node.op_tok.matches(TT_KEYWORD, 'ILLAI'):
...
global_symbol_table.set("ONDRUMILLAI", Number.null)
global_symbol_table.set("POI", Number.false)
global_symbol_table.set("UNMAI", Number.true)
global_symbol_table.set("MATH_PI", Number.math_PI)
global_symbol_table.set("PATHIVU", BuiltInFunction.print)
global_symbol_table.set("PATHIVU_THIRUMBA", BuiltInFunction.print_ret)
global_symbol_table.set("VAANGU", BuiltInFunction.input)
global_symbol_table.set("VAANGU_ENN", BuiltInFunction.input_int)
global_symbol_table.set("AZHI", BuiltInFunction.clear)
global_symbol_table.set("AZHI", BuiltInFunction.clear)
global_symbol_table.set("IDHU_ENNAA", BuiltInFunction.is_number)
global_symbol_table.set("IDHU_ELUTHAA", BuiltInFunction.is_string)
global_symbol_table.set("IDHU_PATTIYALAA", BuiltInFunction.is_list)
global_symbol_table.set("IDHU_SEYALA", BuiltInFunction.is_function)
global_symbol_table.set("SERKA", BuiltInFunction.append)
global_symbol_table.set("NEEKKU", BuiltInFunction.pop)
global_symbol_table.set("NEETU", BuiltInFunction.extend)
global_symbol_table.set("NEELAM", BuiltInFunction.len)
global_symbol_table.set("IYANGU", BuiltInFunction.run)
